...
<body>
  ...
  <div id="cont_AdminHome">
    ...
    <div id="bodyadmin">
      ...
      <p>Admin</p> <br>
      <a href="addadmin.php"><button id="addbus">Add Admin Details</button></a>

      <?php
      include('connect.php');
      $sql = "SELECT AdminID,AdminName,FatherName,Phone,Email
FROM administrator";
            ...
            <form name="actiononbus" method="POST" action="">
              <tr>
                ...
                <td>
                  ...
                  <button name="editadmin" id="actionbusedit" type="submit">EDIT</input>
                </td>
              </tr>
            </form>
          <?php
