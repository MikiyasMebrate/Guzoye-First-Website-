...
<body>
  ...
  <div id="cont_AdminHome">
    ...
    <div id="bodyadmin">
      ...
      <p>Customer</p> <br>
      <a href="addcustomer.php"><button id="addbus">Add Customer Details</button></a>

      <?php
      include('connect.php');
      $sql = "SELECT customer.CutID, customer.CustName,customer.FatherName, customer.Phone, customer.Email
              from customer order by CustName,FatherName ";
          ...
          while ($row = $result->fetch_assoc()) { ?>
            <form name="actiononbus" method="POST" action="">
              <tr>
                ...
                <td>
                  <input type="hidden" name="custid" value="<?php echo $row["CutID"] ?>">
                  <button name="addcustomer" id="actionbusedit" type="submit">EDIT</input>
                </td>
              </tr>
            </form>
          <?php
