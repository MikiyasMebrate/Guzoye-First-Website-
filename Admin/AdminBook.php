...
<body>
  ...
  <div id="cont_AdminHome">
    ...
    <div id="bodyadmin">
      ...
      <?php
      include('connect.php');
      $sql = "SELECT BOOKID,CutID,CustName,FatherName,NumofPassenger,BusNumber,StartingPoint,Destination,TravelDate
from custadmin";
          ...
          while ($row = $result->fetch_assoc()) { ?>
            <form name="actiononbus" method="POST" action="">
              <tr>
                ...
                <input type="hidden" name="BusNum" value="<?php echo $row["CutID"] ?>">
              </tr>
            </form>
          <?php
          }
